/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 100c3e0070a0ba149e4b8e2922f9647d)
...
declare namespace Cloudflare {
	...
	interface Env {
		AI_ANALYSIS: KVNamespace;
		ai_analysis_db: D1Database;
		AI: Ai;
		ENV: "dev";
		SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENV" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY">> {}
}
